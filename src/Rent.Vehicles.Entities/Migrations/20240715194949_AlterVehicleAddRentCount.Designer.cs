...
namespace Rent.Vehicles.Entities.Migrations
{
    ...
    [Migration("20240715194949_AlterVehicleAddRentCount")]
    partial class AlterVehicleAddRentCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Rent.Vehicles.Entities.RentalPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8aa96af9-0d36-426d-87af-a2f843457265"),
                            Created = new DateTime(2024, 7, 15, 16, 49, 49, 440, DateTimeKind.Local).AddTicks(5361),
                            DailyCost = 30.0m,
                            NumberOfDays = 7,
                        ...
                        new
                        {
                            Id = new Guid("5583ab72-7a4d-42b7-b72e-ab9f4fa36d27"),
                            Created = new DateTime(2024, 7, 15, 16, 49, 49, 440, DateTimeKind.Local).AddTicks(5429),
                            DailyCost = 28.0m,
                            NumberOfDays = 15,
                            PostEndDateFine = 50.0m,
                        ...
                        new
                        {
                            Id = new Guid("e6768c11-40ff-406c-bc79-343aaaafbfb0"),
                            Created = new DateTime(2024, 7, 15, 16, 49, 49, 440, DateTimeKind.Local).AddTicks(5438),
                            DailyCost = 22.0m,
                            NumberOfDays = 30,
                            PostEndDateFine = 50.0m,
                        ...
                        new
                        {
                            Id = new Guid("c8bb6d3f-4e75-4525-90ad-4db54a19e7c9"),
                            Created = new DateTime(2024, 7, 15, 16, 49, 49, 440, DateTimeKind.Local).AddTicks(5445),
                            DailyCost = 20.0m,
                            NumberOfDays = 45,
                            PostEndDateFine = 50.0m,
                            PreEndDatePercentageFine = 1.0m
                        ...
                        new
                        {
                            Id = new Guid("3962fd2e-c0d7-4040-bb25-fa5d5f3a8367"),
                            Created = new DateTime(2024, 7, 15, 16, 49, 49, 440, DateTimeKind.Local).AddTicks(5451),
                            DailyCost = 18.0m,
                            NumberOfDays = 50,
                            PostEndDateFine = 50.0m,
                            PreEndDatePercentageFine = 1.0m
